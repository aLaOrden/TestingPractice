...
<head>
    ...
    <link rel="stylesheet" href="${createLinkTo(dir:'stylesheet',file:'navbar.css')}" type="text/css">
        ...
        <div class="navbar-fixed">
            <nav class="indigo lighten-2">
                <div class="nav-wrapper col s10 offset-s1">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="home" class="brand-logo">UNCake</a>
                    <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>

                    <ul class="right hide-on-med-and-down">
                        <li><a href="#"><i class="material-icons left">note_add</i>Registrarme</a></li>
                        <li><a href="#"><i class="material-icons left">supervisor_account</i>Ingresar</a></li>
                    </ul>
...
<footer class="page-footer indigo lighten-2">
    <div class="container">
        <div class="col s12 center-align">
            <p class="grey-text text-lighten-4">Planea tu horario de clases, busca edificios en el campus, haz seguimiento a tu historia académica y proyecta tus notas.</p>
        </div>
    </div>
